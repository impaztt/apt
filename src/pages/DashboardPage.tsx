      ...
      <Card className="overflow-hidden p-0 shadow-none">
          ...
          <div className="px-4 pb-1 sm:px-5">
            <div className="border-b border-slate-100 py-3">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    type="button"
                    className="rounded-lg bg-brand-50 px-2.5 py-1.5 text-[11px] font-semibold text-brand-700"
                  ...
                  <button
                    type="button"
                    className="rounded-lg bg-slate-50 px-2.5 py-1.5 text-[11px] font-semibold text-slate-500"
                  ...
                  <span className="rounded-full bg-brand-50 px-2 py-1 text-[11px] font-bold text-brand-700">
                    {complexIds.length}/{groupComplexIds.length}
                  </span>
                </div>
              </div>
            ...
            <div className="divide-y divide-slate-100">
              <SpecialUnitToggle compact checked={includeSpecialUnits} onChange={setIncludeSpecialUnits} specialCount={specialSaleCount} />
